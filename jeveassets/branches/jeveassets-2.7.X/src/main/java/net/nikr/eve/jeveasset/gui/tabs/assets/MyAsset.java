...
public class MyAsset implements Comparable<MyAsset>, InfoItem, LocationType, ItemType, BlueprintType, PriceType, TagsType {
	...
	public MyAsset(final Item item, final Location location, final Owner owner, final long count, final List<MyAsset> parents, final String flag, final int flagID, final long itemID, final boolean singleton, final int rawQuantity) {
		this.item = item;
