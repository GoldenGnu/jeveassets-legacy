...
public class JournalTab extends JMainTab {
	...
	private EnumTableFormatAdaptor<JournalTableFormat, MyJournal> tableFormat;
	private DefaultEventTableModel<MyJournal> tableModel;
	private FilterList<MyJournal> filterList;
	private EventList<MyJournal> eventList;
	private DefaultEventSelectionModel<MyJournal> selectionModel;
	...
	public static class JournalFilterControl extends FilterControl<MyJournal> {
