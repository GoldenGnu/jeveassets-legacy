...
public class ContractsTab extends JMainTab {
	...
	//Table
	private EventList<MyContractItem> eventList;
	private FilterList<MyContractItem> filterList;
	private SeparatorList<MyContractItem> separatorList;
	private DefaultEventSelectionModel<MyContractItem> selectionModel;
	private DefaultEventTableModel<MyContractItem> tableModel;
	private EnumTableFormatAdaptor<ContractsTableFormat, MyContractItem> tableFormat;
	...
	public class ContractsFilterControl extends FilterControl<MyContractItem> {
