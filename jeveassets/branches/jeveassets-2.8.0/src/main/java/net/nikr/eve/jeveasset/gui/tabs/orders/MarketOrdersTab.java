...
public class MarketOrdersTab extends JMainTab {
	...
	private EnumTableFormatAdaptor<MarketTableFormat, MyMarketOrder> tableFormat;
	private DefaultEventTableModel<MyMarketOrder> tableModel;
	private FilterList<MyMarketOrder> filterList;
	private EventList<MyMarketOrder> eventList;
	private DefaultEventSelectionModel<MyMarketOrder> selectionModel;
	...
	public static class MarketOrdersFilterControl extends FilterControl<MyMarketOrder> {
