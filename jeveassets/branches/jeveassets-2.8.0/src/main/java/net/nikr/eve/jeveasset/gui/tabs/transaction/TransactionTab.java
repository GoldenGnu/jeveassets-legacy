...
public class TransactionTab extends JMainTab {
	...
	private EnumTableFormatAdaptor<TransactionTableFormat, MyTransaction> tableFormat;
	private DefaultEventTableModel<MyTransaction> tableModel;
	private FilterList<MyTransaction> filterList;
	private EventList<MyTransaction> eventList;
	private DefaultEventSelectionModel<MyTransaction> selectionModel;
	...
	public static class TransactionsFilterControl extends FilterControl<MyTransaction> {
