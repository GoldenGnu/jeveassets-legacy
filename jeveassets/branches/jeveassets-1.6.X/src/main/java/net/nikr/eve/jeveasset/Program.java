...
public class Program implements ActionListener, Listener<EveAsset>{
	...
	//Dialogs
		...
		filtersManagerDialog = new FiltersManagerDialog(this, Images.ASSETS_LOAD_FILTER.getImage());
		SplashUpdater.setProgress(76);
		LOG.info("Loading: Account Manager Dialog");
		accountManagerDialog = new AccountManagerDialog(this, Images.DIALOG_ACCOUNTS.getImage());
		SplashUpdater.setProgress(78);
		LOG.info("Loading: About Dialog");
		aboutDialog = new AboutDialog(this, Images.DIALOG_ABOUT.getImage());
		SplashUpdater.setProgress(80);
		LOG.info("Loading: Csv Export Dialog");
		csvExportDialog = new CsvExportDialog(this, Images.DIALOG_CSV_EXPORT.getImage());
		SplashUpdater.setProgress(82);
		LOG.info("Loading: Profiles Dialog");
		profileDialog = new ProfileDialog(this, Images.DIALOG_PROFILES.getImage());
		SplashUpdater.setProgress(84);
		LOG.info("Loading: Update Dialog");
		updateDialog = new UpdateDialog(this, Images.DIALOG_UPDATE.getImage());
		SplashUpdater.setProgress(86);
	//Settings
		LOG.info("Loading: Options Dialog");
		settingsDialog = new SettingsDialog(this, Images.DIALOG_SETTINGS.getImage());
		SplashUpdater.setProgress(87);
		LOG.info("Loading: General Settings Panel");
		generalSettingsPanel = new GeneralSettingsPanel(this, settingsDialog, Images.DIALOG_SETTINGS.getIcon());
		...
		assetsToolSettingsPanel = new AssetsToolSettingsPanel(this, settingsDialog, Images.TOOL_ASSETS.getIcon(), toolNode);
		SplashUpdater.setProgress(89);
		LOG.info("Loading: Overview Tool Settings Panel");
		overviewToolSettingsPanel = new OverviewToolSettingsPanel(this, settingsDialog, Images.TOOL_OVERVIEW.getIcon(), toolNode);
		...
		userPriceSettingsPanel = new UserPriceSettingsPanel(this, settingsDialog, Images.SETTINGS_USER_PRICE.getIcon(), modifiedAssetsNode);
		SplashUpdater.setProgress(91);
		LOG.info("Loading: Assets Name Settings Panel");
		userNameSettingsPanel = new UserNameSettingsPanel(this, settingsDialog, Images.SETTINGS_USER_NAME.getIcon(), modifiedAssetsNode);
		SplashUpdater.setProgress(92);
		LOG.info("Loading: Price Data Settings Panel");
		priceDataSettingsPanel = new PriceDataSettingsPanel(this, settingsDialog, Images.SETTINGS_PRICE_DATA.getIcon());
		SplashUpdater.setProgress(93);
		LOG.info("Loading: Reprocessing Settings Panel");
		reprocessingSettingsPanel = new ReprocessingSettingsPanel(this, settingsDialog, Images.SETTINGS_REPROCESSING.getIcon());
		SplashUpdater.setProgress(94);
		LOG.info("Loading: Proxy Settings Panel");
		proxySettingsPanel = new ProxySettingsPanel(this, settingsDialog, Images.SETTINGS_PROXY.getIcon());
		SplashUpdater.setProgress(95);
		LOG.info("Loading: Window Settings Panel");
		windowSettingsPanel = new WindowSettingsPanel(this, settingsDialog, Images.SETTINGS_WINDOW.getIcon());
